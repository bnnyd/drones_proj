...
class Screen():
    def __init__(self):
        self.root = Tk()
        self.canvas = Canvas(self.root, height = 360, width = 150)
        self.states_rec = {}
        ...
        self.states_rec[States.PICTURE_HOVERING] = self.canvas.create_rectangle(10, 210, 140, 250, fill="#C2B6BF")
        self.canvas.create_text((75, 230), text="PIC HOVERING")
        self.states_rec[States.LANDING] = self.canvas.create_rectangle(10, 260, 140, 300, fill="#C2B6BF")
        self.canvas.create_text((75, 280), text="LANDING")
        self.states_rec[States.STOP] = self.canvas.create_rectangle(10, 310, 140, 350, fill="#C2B6BF")
        self.canvas.create_text((70, 330), text="STOP")
        self.canvas.pack()
        self.root.update()
